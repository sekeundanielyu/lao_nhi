...
# Figure 2. DiD analysis
<br>
```{r fig_2, eval=FALSE, include=FALSE}
...
write_xlsx(plot.dyn, paste0("./output/", "fig_02_did_main.xlsx"))
...
# Vector file
pdf("./graph/fig_02_did_main.pdf", width = 5.1, height = 6, 
...
# Supplementary Figure B3. DiD analysis by facility type
<br>
```{r fig_b_3_facility, eval=FALSE, include=FALSE}
...
write_xlsx(plot.fac, paste0("./output/", "fig_b_03_did_facility.xlsx"))
...
# Vector file
pdf("./graph/fig_b_03_did_facility.pdf", width = 4, height = 5.5, 
    family = "Source Sans Pro")
print(plot)
dev.off()
...
# Supplementary Figure B4. DiD analysis by district-level poverty status
<br>
```{r fig_b_4_poverty, eval=FALSE, include=FALSE}

plot.pov <- read_excel("./output/fig_b_04_did_poverty.xlsx")
plot.pov <- plot.pov %>%
...
write_xlsx(plot.pov, paste0("./output/", "fig_b_04_did_poverty.xlsx"))
...
# Vector file
pdf("./graph/fig_b_04_did_poverty.pdf", width = 5.1, height = 6, 
    family = "Source Sans Pro")
print(plot)
dev.off()
...
# Supplementary Figure B5. DiD analysis by intervention group
<br>
```{r fig_b_5_group, eval=FALSE, include=FALSE}
...
write_xlsx(plot.grp, paste0("./output/", "fig_b_05_did_group.xlsx"))
...
# Vector file
pdf("./graph/fig_b_05_did_group.pdf", width = 4.75, height = 7, 
    family = "Source Sans Pro")
print(plot)
dev.off()
...
# Supplementary Figure B6. DiD analysis with adjusted model specifications 
# (balanced, last-treated, no covariate)
<br>
```{r fig_b_6_adjust, eval=FALSE, include=FALSE}
...
write_xlsx(plot.ajt, paste0("./output/", "fig_b_06_did_adjust.xlsx"))
...
# Vector file
pdf("./graph/fig_b_06_did_adjust.pdf", width = 4.75, height = 7, 
    family = "Source Sans Pro")
print(plot)
dev.off()
...
# Supplementary Figure B7. Difference-in-differences analysis using alternative heterogeneity-robust estimators
<br>
```{r fig_b_7_hetero, eval=FALSE, include=FALSE}

data.htr <- read_excel("./output/fig_b_07_did_hetero.xlsx")
...
# Vector file
pdf("./graph/fig_b_07_did_hetro.pdf", width = 5.1, height = 6, 
    family = "Source Sans Pro")
print(plot)
dev.off()
...
# Supplementary Figure B8. DiD analysis with count data
<br>
```{r fig_b_8_count, eval=FALSE, include=FALSE}
...
write_xlsx(plot.cnt, paste0("./output/","fig_b_08_did_count.xlsx"))
...
# Vector file
pdf("./graph/fig_b_08_did_count.pdf", width = 4.75, height = 7, 
    family = "Source Sans Pro")
print(plot)
dev.off()
...
# Supplementary Figure B9. DiD analysis using monthly data
<br>
```{r fig_b_9_month, eval=FALSE, include=FALSE}
...
write_xlsx(plot.ajt, paste0("./output/","fig_b_09_did_month.xlsx"))
...
# Vector file
pdf("./graph/fig_b_09_did_month.pdf", width = 4.75, height = 7, 
    family = "Source Sans Pro")
print(plot)
dev.off()
...
# Supplementary Figure B10. Robustness to violation of parallel trends
<br>
```{r fig_b_10_honest, eval=FALSE, include=FALSE}
...
write_xlsx(plot.hon, paste0("./output/", "fig_b_10_did_honest.xlsx"))
...
# Vector file
pdf("./graph/fig_b_10_did_honest.pdf", width = 4, height = 3.5, 
    family = "Source Sans Pro")
print(plot)
dev.off()
...
# Supplementary Figure B11. Controlled interrupted time series analyses
<br>
```{r fig_b_11_cits, eval=FALSE, include=FALSE}
...
write_xlsx(plot.its, "./output/fig_b_11_cits.xlsx")
...
# Vector file
pdf("./graph/fig_b_11_cits.pdf", width = 5.5, height = 6, 
    family = "Source Sans Pro")
print(plot)
dev.off()
