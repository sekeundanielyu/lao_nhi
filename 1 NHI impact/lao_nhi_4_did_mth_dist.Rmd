...
# Log
logpath <- file.path(getwd(), "log", "lao_nhi_4_did_mth_dist.log")
...
sep("Controlled interrupted time series analysis (monthly)")
...
data.its$month_fac <- factor(format(data.its$month, "%m"),
                               levels = sprintf("%02d", 1:12),
                               labels = month.abb)
unique(data.its$month_fac)
