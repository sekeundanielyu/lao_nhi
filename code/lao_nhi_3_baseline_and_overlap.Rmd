...
<br>
```{r fig_1_a, echo=TRUE, message=FALSE, results="hide"}
...
plot_scheme <- ggplot(
  ...
  ylab("Population") + 
  xlab("Year") +
  annotate("text", x = 7.5, y = 2900000, label = "33%", size = 3.1) +
  geom_segment(aes(x = 7.7, y = 2650000, xend = 8, yend = 2400000),
               arrow = arrow(length = unit(0.05, "in")),
               color = "grey30") +
  annotate("text", x = 9.5, y = 7150000, label = "93%", size = 3.1) +
  geom_segment(aes(x = 9.7, y = 6900000, xend = 10, yend = 6650000),
               arrow = arrow(length = unit(0.05, "in")),
               color = "grey30") +
  ggtitle("**Panel A.** Population coverage by health protection scheme, 2008-2021") +
  theme_light() +
  theme(
    ...
    plot.title = element_markdown(
      hjust = 0,          # fully left align
      size = 12,
      colour = "black",
      margin = margin(b = 20)),
    plot.margin = margin(t = 0.1, r = 0.05, b = 0.1, l = 0.3, unit = "in"),
...
# Vector file
pdf("./graph/fig_01_population_scheme.pdf",
    width = 6.3, height = 6.6, family = "Source Sans Pro")
print(plot_scheme)
dev.off()
...
<br>
```{r fig_1_b, echo=TRUE, message=FALSE, results="hide"}
...
write_xlsx(data.num2, "./output/fig_a_01_district_num.xlsx")
...
plot_district <- ggplot(
  ...
  labs(fill = NULL,
       ...
       x = "Quarter") +
  ggtitle("**Panel B.** Timeline of NHI expansion, 2015-2019") +
  theme_light() +
  theme(
...
# Vector file
pdf("./graph/fig_01_district_num.pdf",
    width = 5.5, height = 6, family = "Source Sans Pro")
print(plot_district)
dev.off()

# Combine graphs
plot_scheme_clean  <- plot_scheme  + theme(plot.margin = margin(r = 30))
plot_dist_clean <- plot_district + theme(
  legend.box.margin = margin(t = -35))
plot_scheme_dist <- plot_scheme_clean + plot_dist_clean + plot_layout(ncol = 2)

# Save
pdf("./graph/fig_01_scheme_district.pdf",
    width = 10, height = 6.5, family = "Source Sans Pro")
print(plot_scheme_dist)
dev.off()
...
<br>
```{r fig_a_1, echo=TRUE, fig.height=2.5, fig.width=5}
...
pdf("./graph/fig_a_01_overlap.pdf", 
    width = 5, height = 2.5, family = "Source Sans Pro")
...
## B5. Health service utilization trends
<br>
...
<br>
```{r fig_b_1, echo=TRUE, warning=TRUE}
...
# Vector file
pdf("./graph/fig_b_01_pta_overall.pdf", 
    width = 5.1, height = 6, family = "Source Sans Pro")
print(plot)
dev.off()
...
<br>
```{r fig_b_2, echo=TRUE, warning=TRUE}
...
# Vector file
pdf("./graph/fig_b_02_pta_cohort.pdf", 
    width = 4.75, height = 7, family = "Source Sans Pro")
print(plot)
dev.off()
